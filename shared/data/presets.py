...
# ─────────────────────────────────────────────────────────
# 업종별 부서 인원 비중 및 급여 배율 테이블
# (DART/SEC 공시 데이터 → 부서 추정에 사용)
# 출처: Goldman Sachs 2023, McKinsey MGI 2025, 업종 관행 종합
# ─────────────────────────────────────────────────────────

DEPT_HEADCOUNT_SHARE: dict[str, dict] = {
    "IT소프트웨어": {
        "엔지니어링/개발": 0.45,
        "영업/마케팅":    0.15,
        "고객서비스(CS)": 0.10,
        ...
        "운영/물류":      0.05,
        "법무/컴플라이언스": 0.04,
        "_source": "McKinsey MGI 2025, 국내 IT기업 평균",
    },
    "금융보험": {
        "운영/물류":      0.30,
        "고객서비스(CS)": 0.20,
        ...
        "HR":             0.04,
        "엔지니어링/개발": 0.02,
        "_source": "Goldman Sachs 2023, McKinsey MGI 2025",
    },
    "제조": {
        "운영/물류":      0.45,
        "엔지니어링/개발": 0.20,
...
# 업종별 부서 급여 배율 (전체 평균 = 1.0 기준)
DEPT_SALARY_MULTIPLIER: dict[str, dict] = {
    "IT소프트웨어": {
        "엔지니어링/개발": 1.6,
        "영업/마케팅":    1.1,
        "고객서비스(CS)": 0.8,
